...
| 9시 대기 전 과정 (대한항공) | T-90초 준비 → 정각 발사 → 좌석 선택까지 성공 | 2026-09-20 |
| 9시 대기 (아시아나) | 준비 12.8초 · 발사 6.4초 · `OZ102 22,500마일` | 2026-09-20 |
| 오픈 범위 차이 | 대한항공 +360일 / 아시아나 +364일 | 2026-09-20 |
...
두 항공사 모두 **매일 09:00 KST에 예매 범위의 마지막 날짜**를 연다. 장거리 인기 노선은
몇 분 안에 나가므로, 9시에 조회를 *시작*하면 이미 늦다.

**범위가 항공사마다 다르다** (2026-09-20 실측):

| 항공사 | 범위 | 그날 열린 마지막 날짜 |
|---|---|---|
| 대한항공 | **360일** | 2027-09-15 |
| 아시아나 | **364일** | 2027-09-18 |

같은 날짜라도 **아시아나가 4일 먼저 열린다.** 그래서 오픈일을 항공사별로 계산한다
(`RELEASE_WINDOWS`). 아시아나는 일등석을 팔지 않으므로 그 조합은 거부한다.
...
| 상수 | 값 | 근거 |
|---|---|---|
| `RELEASE_HOUR` | 9 | 두 항공사 공통 |
| `RELEASE_WINDOWS` | 대한항공 360 / 아시아나 364 | 실측 (위 표) |
...
아시아나 폼은 대한항공보다 단계가 많다 — 좌석등급을 **반드시** 골라야 하고, `항공권 조회`가
안내 레이어를 열 뿐이라 **그 레이어의 확인**이 실제 제출이다. 그만큼 미리 채워두는
효과가 크다(준비 12.8초 / 발사 6.4초).
